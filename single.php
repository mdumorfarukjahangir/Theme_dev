        ...
        <div class="col-full s-content__main">
            ...
            <div class="s-content__author">
                ...
                <div class="s-content__author-about">
                    ...
                    <?php 
                      $author_facebook = get_field("facebook", "user_".get_the_author_meta("ID"));
                      $author_twitter = get_field("twitter", "user_".get_the_author_meta("ID"));
                      $author_linkend = get_field("linkend", "user_".get_the_author_meta("ID"));
                      $author_instragram = get_field("instragram", "user_".get_the_author_meta("ID"));
                    ?>
                    ...
                    <?php endif; ?>
                    <?php  if($author_linkend): ?>
                        <li><a href="<?php echo esc_url($author_linkend); ?>">Linkedin</a></li>
                    <?php endif; ?>
                    <?php  if($author_instragram): ?>
                        <li><a href="<?php echo esc_url($author_instragram); ?>">Instragram</a></li>
                    <?php endif; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="s-content__pagenav">
                <div class="s-content__nav">
                    ...
                    ?>
                        <a href="<?php echo esc_url(get_the_permalink( $philosophy_previous_post )); ?>" rel="prev">
                            <span><?php _e("Previous Post","philosophy"); ?></span>
                            <?php 
                              echo get_the_title($philosophy_previous_post);
                            ?>
                        </a>
                        <?php 
                          endif;
